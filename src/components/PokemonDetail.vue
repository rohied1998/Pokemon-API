    ...
    <div class="detail-view" v-if="show">
      ...
      <div v-if="pokemon" class="data">
        ...
        <div class="property">
         ...
         <div class="property">
          <div class="left">Is default</div>
          <div class="right">{{ pokemon.is_default }}</div>
        </div>
         <div class="property">
...
border-bottom: 1px solid #ccc;
 ...
 .detail .detail-view .data .types, .detail .detail-view .data .abilities {
display: flex;
justify-content: flex-start;
flex-wrap: wrap;
width: 90%;
max-width: 400px;
 ...
 .detail .detail-view .data .types .type, .detail .detail-view .data .abilities .type, .detail .detail-view .data .types .ability, .detail .detail-view .data .abilities .ability {
...
word-break: keep-all;
 ...
 .detail .detail-view .data .types .type, .detail .detail-view .data .abilities .type {
background-color: #0a2e50;
}
 .detail .detail-view .data .types .ability, .detail .detail-view .data .abilities .ability {
